//this file is from: https://github.com/raulriera/XHR
//just changed a bit.
...
REST.prototype.endpoint = function(path){
	var url = "https://keja.me/school/mobile/tinderbox/api/v.1.0.0";
	return url + path;
};
...
// @extraParams (object)
REST.prototype.GET = function(url, onSuccess, onError, extraParams) {
...
// @onError (function) error callback
// @extraParams (object)
REST.prototype.POST = function(url, data, onSuccess, onError, extraParams) {
...
// @onError (function) error callback
// @extraParams (object)
REST.prototype.PUT = function(url, data, onSuccess, onError, extraParams) {
...
// @onError (function) error callback
// @extraParams (object)
REST.prototype.DELETE = function(url, onSuccess, onError, extraParams) {
...
REST.prototype.clear = function(url) {
...
REST.prototype.setStaticOptions = function(params) {
